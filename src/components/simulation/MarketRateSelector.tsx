...
export function MarketRateSelector({
  ...
  return <div className="space-y-2">
      ...
      {selectedType === "ipca_plus" && <div className="animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="flex-wrap gap-2 p-3 rounded-lg bg-muted/50 border flex-col flex items-center justify-center">
            <div className="gap-2 flex-col flex items-start justify-center">
